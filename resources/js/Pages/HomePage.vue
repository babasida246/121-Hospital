          ...
          <div class="row">
            ...
            >
              ...
              <div class="icon-box">
                ...
                <h4 class="title"><a href="">Tư vấn bảo hiểm y tế</a></h4>
                <p class="description">
              ...
              <div class="icon-box">
                ...
                <h4 class="title">
                  <a href="">Quy trình đăng ký và khám chữa bệnh</a>
                </h4>
                <p class="description">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
              <div class="icon-box">
                ...
                <h4><a href="">Điều trị kỹ thuật cao</a></h4>
                <p>
              ...
              <ul class="nav nav-tabs flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="tab" href="#tab-8"
                    >Ngoại tổng quát - Lồng ngực</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="tab" href="#tab-9"
                    >Hồi sức tích cực - Gây mê phẫu thuật</a
                  >
                </li>
                <li class="nav-item">
            ...
            <div class="col-lg-4">
              <div class="info">
                <div class="address">
                  ...
                  <h4>Địa chỉ:</h4>
                  <p>Số 01, đường 30/4, phường An Lạc, quận Ninh Kiều, TP Cần Thơ</p>
                </div>
