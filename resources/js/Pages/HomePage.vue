<template>
  <guest-layout>
    <div class="d-none d-lg-block" id="bhyt">
      ...
      <div class="d-flex">
        <div class="info">
          <p>
            ...
            commodi blanditiis atque doloremque illo hic, optio, pariatur itaque
            excepturi unde mollitia dolorem. Doloremque, sapiente architecto!
            Adipisci commodi ex animi est.
          </p>
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Possimus
            commodi blanditiis atque doloremque illo hic, optio, pariatur itaque
        ...
        <div class="dangky">
          <form action="|" class="me-3 border p-2">
            ...
            <div class="input-group mb-3">
              <span class="input-group-text" id="basic-addon3">Họ và tên</span>
              <input
                type="text"
                class="form-control"
                id="basic-url"
      ...
      <div class="justify-content-center">
        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-center">
                    ...
                    <application-modal
                      modalID="banggiaTYC"
                      modalTitle="Bảng giá dịch vụ khám chữa bệnh theo yêu cầu"
                      savebutton="false"
                    ></application-modal>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-center">
                    ...
                    <button
                      ...
                      class="btn btn-primary ms-1"
                      data-bs-toggle="modal"
                      data-bs-target="#banggiagoikcb"
                    >
                      Bảng giá dịch vụ
                    </button>
                    <application-modal
                      modalID="goikhamsk"
                      modalTitle="Đăng ký gói khám sức khỏe"
                      savebutton="false"
                    ></application-modal>
                    <application-modal
                      modalID="banggiagoikcb"
                      modalTitle="Bảng giá các gói dịch vụ khám sức khỏe"
                      savebutton="false"
                    ></application-modal>
                  </div>
                </div>
            ...
            <div class="col-lg-4 mb-3 d-none d-sm-block">
              <div class="card h-100">
                <div class="card-header text-center">
                  <h5 class="service-header">
                ...
                <div class="card-body">
                  <p>
                    Các ký thuật chuẩn đoán hình ảnh và chức năng đang triển
                    khai tại Bệnh viện
                  </p>
                  <div class="d-flex justify-content-center">
                    <button
            ...
            <div class="col-lg-4 mb-3 d-none d-sm-block">
              <div class="card h-100">
                <div class="card-header text-center">
                  <h5 class="service-header">
                    <font-awesome-icon :icon="['fas', 'file-medical']" /><br />
                    Phẫu thuật - kỹ thuật cao
                  </h5>
                </div>
                <div class="card-body">
                  <p>
                    Các phẫu thuật-kỹ thuật cao đang triển khai tại Bệnh viện
                  </p>
                  <div class="d-flex justify-content-center">
                    <button
                      type="button"
